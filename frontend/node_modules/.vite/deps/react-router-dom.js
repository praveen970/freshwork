import {
  require_react_dom
} from "./chunk-WU7GAZWG.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-GFHJP6GL.js";
...
function createRouter(init) {
  ...
  function completeNavigation(location2, newState, { flushSync: flushSync3 } = {}) {
    ...
    if (pendingAction === "POP" && !isUninterruptedRevalidation && location2 !== state.location) {
  ...
  async function startRedirectNavigation(request, redirect2, isNavigation, {
    ...
    let originalLocation = location2;
